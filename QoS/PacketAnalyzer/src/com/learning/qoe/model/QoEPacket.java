...
public class QoEPacket implements Serializable{
     ...
     * Stores TCP Segments
     */
    private List<TCPSegment> tcpSegments;
    
    /**
     * Add TCP Segment in Collection
     * @param tcpSegment
     */
    public void addTCPSegment(final TCPSegment tcpSegment) {
        if ( tcpSegments == null ) {
            tcpSegments = new ArrayList<TCPSegment>();
        }
    ...
    public List<TCPSegment> getTcpSegments() {
        return tcpSegments;
    }


    public void setTcpSegments(List<TCPSegment> tcpSegments) {
