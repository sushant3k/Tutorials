...
import wseemann.media.jplaylistparser.ASXPlaylistParser;
import wseemann.media.jplaylistparser.M3UPlaylistParser;
import wseemann.media.jplaylistparser.M3U8PlaylistParser;
import wseemann.media.jplaylistparser.PLSPlaylistParser;
import wseemann.media.jplaylistparser.XSPFPlaylistParser;
...
public class AutoDetectParser {
    ...
    public PlayListAbstractClass parse(
    		String uri,
    		String mimeType,
            InputStream stream,
            PlayListAbstractClass playlist)
		...
		PlayListAbstractClass obj=parser.parseM3U8(uri, stream, playlist);
		return obj;
    }
    ...
    public PlayListAbstractClass parse(
		...
		PlayListAbstractClass obj=parser.parseM3U8File(uri, stream);
		return obj;
    }
